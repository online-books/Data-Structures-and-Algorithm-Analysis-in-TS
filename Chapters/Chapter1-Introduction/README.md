...
### 2.算法分析
---
**算法**是为求解一个问题需要遵循的、被清楚地指定的简单指令的集合。对于一个问题，如果给定某个正确的算法，那么重要的一步就是确定该算法需要多少时间或空间等资源量的问题。如果一个问题的求解算法需要长达一年时间，那么这种算法就很难有什么用处。估计算法资源消耗所需的分析是一个理论问题，因此需要一套正式的系统构架，我们先从下面的四个定义开始。
